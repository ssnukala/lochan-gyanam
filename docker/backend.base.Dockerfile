...
COPY framework/lochan/packages/daksh/build/runtime/install-framework-packages.py /build/install-framework-packages.py
...
# 4. Helper scripts
COPY framework/lochan/packages/daksh/build/runtime/install-packages.py /app/scripts/
